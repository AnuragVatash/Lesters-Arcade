    ...
    steps: [
      {
        ...
        content:
          "Welcome to Lester's Arcade! This tutorial will guide you through the basics of our hacking simulation games.",
        position: "center",
        animation: "fade",
        skipable: true,
      },
      {
        ...
        title: "Navigation",
        content:
          "Use the navigation bar at the top to switch between different games and access the leaderboard.",
        target: "nav",
        position: "bottom",
        action: "hover",
        actionTarget: "nav",
      ...
      },
      {
        ...
        content:
          "Your username and status are displayed in the top-left corner. Guest users have limited access to some features.",
        target: ".user-info",
        position: "right",
        animation: "pulse",
      },
      {
        ...
        content:
          "Click on any game button to start playing. Each game has its own unique hacking challenge.",
        target: ".game-nav",
        position: "bottom",
        action: "click",
      ...
      },
      {
        ...
        title: "Settings",
        content:
          "Access settings and customization options by clicking the settings button or using Ctrl+S.",
        target: ".settings-btn",
        position: "left",
        action: "click",
    ...
    steps: [
      {
        ...
        content:
          "In this game, you need to identify the correct fingerprint pieces to complete the hack. Look for the target fingerprint on the right.",
        position: "center",
        animation: "fade",
      },
      {
        ...
        content:
          "The left panel shows 8 fingerprint pieces. You need to select exactly 4 pieces that match the target fingerprint.",
      ...
      },
      {
        ...
        content:
          "The right panel shows the target fingerprint you need to recreate. Study it carefully before making your selections.",
      ...
      },
      {
        ...
        content:
          "Click on fingerprint pieces to select them. Selected pieces will be highlighted. You can deselect by clicking again.",
      ...
      },
      {
        ...
        content:
          "Once you have selected 4 pieces, press Enter or click the submit button to check your answer.",
        target: ".submit-btn",
        position: "top",
        action: "click",
      ...
      },
      {
        ...
        content:
          "After submission, the system will scan your selection. If correct, you'll see a success message and your time will be recorded.",
        position: "center",
        animation: "fade",
      },
    ],
    ...
    steps: [
      {
        ...
        content:
          "Welcome to the Cayo Perico island breach. This is a more complex hacking challenge involving multiple security layers.",
        position: "center",
        animation: "fade",
      },
      {
        ...
        content:
          "The island has multiple security layers. You need to breach each layer in sequence to reach the main vault.",
      ...
      },
      {
        ...
        content:
          "Each security layer has a timing window. You must complete the hack within the time limit to proceed.",
        target: ".timer",
        position: "top",
        animation: "pulse",
      },
      {
        ...
        content:
          "Look for patterns in the security codes. The correct sequence will unlock the next layer.",
    ...
    steps: [
      {
        ...
        content:
          "In this challenge, you need to find specific numbers hidden in a complex pattern. Speed and accuracy are key.",
        position: "center",
        animation: "fade",
      },
      {
        ...
        title: "Number Grid",
        content:
          "The grid contains many numbers. Your goal is to find the target numbers as quickly as possible.",
        target: ".number-grid",
        position: "bottom",
        animation: "glow",
      },
      {
        ...
        content:
          "The target numbers are displayed at the top. Click on matching numbers in the grid to select them.",
    ...
    steps: [
      {
        ...
        content:
          "Keyboard shortcuts can significantly speed up your gameplay. Let's learn the most important ones.",
        position: "center",
        animation: "fade",
      },
      {
        ...
        title: "Game Controls",
        content:
          "Press Enter to start games and submit selections. Use Ctrl+R to reset the current game.",
        position: "center",
        animation: "slide",
      },
      {
        ...
        content:
          "Use number keys 1-3 to quickly switch between games. Press Ctrl+L for leaderboard, Ctrl+S for settings.",
        position: "center",
        animation: "slide",
      },
      {
        ...
        title: "UI Shortcuts",
        content:
          "Press F for fullscreen, Ctrl+Plus/Minus for zoom, and ? for help.",
        position: "center",
        animation: "slide",
      },
    ],
    ...
    steps: [
      {
        ...
        content:
          "Lester's Arcade includes various accessibility features to ensure everyone can enjoy the games.",
        position: "center",
        animation: "fade",
      },
      {
        ...
        content:
          "Enable high contrast mode for better visibility. Press Ctrl+Shift+H to toggle.",
        position: "center",
        animation: "slide",
      },
      {
        ...
        content:
          "Increase text size for better readability. Press Ctrl+Shift+T to toggle.",
        position: "center",
        animation: "slide",
      },
      {
        ...
        content:
          "The interface is designed to work with screen readers and other assistive technologies.",
        position: "center",
        animation: "slide",
      },
    ],
...
export class TutorialManager {
  ...
  private listeners: Set<(tutorial: Tutorial, step: TutorialStep) => void> =
    new Set();
  ...
  subscribe(
    listener: (tutorial: Tutorial, step: TutorialStep) => void
  ): () => void {
...
export const useTutorials = () => {
  ...
  return {
    ...
    subscribe: (listener: (tutorial: Tutorial, step: TutorialStep) => void) =>
