...
export default function VolumeControl({
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (saved) {
        try {
          const config = JSON.parse(saved) as Partial<StoredAudioConfig>;
  ...
  // Save settings
  const saveConfig = (config: StoredAudioConfig) => {
    if (typeof window !== "undefined") {
      localStorage.setItem(
        "lester-arcade-audio-config",
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <span>{isMuted ? "AUDIO.off" : "AUDIO.exe"}</span>
        <span
          className={cn(
      ...
      {isExpanded && (
        <div className="absolute top-full right-0 mt-2 w-80 bg-black/95 border border-green-500/30 rounded-lg p-4 shadow-2xl shadow-green-500/20 z-50">
          <div className="space-y-4">
            <div className="text-green-300 text-sm font-mono mb-3">
              AUDIO CONTROLS
            </div>
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                step={1}
                onValueChange={(vals) =>
                  handleMasterVolumeChange(vals[0] / 100)
                }
                className="w-full"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                max={100}
                step={1}
                onValueChange={(vals) => handleSfxVolumeChange(vals[0] / 100)}
                className="w-full"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                max={100}
                step={1}
                onValueChange={(vals) => handleMusicVolumeChange(vals[0] / 100)}
                className="w-full"
              />
            </div>
